 ...
 * 
 */
public class AppFeedbackMain {
	private static Logger logger = Logger.getLogger(AppFeedbackMain.class);

	public final static String MODULE_KAFKA_APPFEEDBACK = "kafka-appfeedback";

	public static void main(String[] args) {
		if (args.length != 4) {
			System.out
					.println("Usage : java com.lenovo.push.marketing.lestat.kafka.appfeedback.AppFeedbackMain -Dlestat.home=<lestat.home> -Dlogfile.name=<logfile.name> kafka-appfeedback <readerIndex> <readerCount> <yyyyMMddHHmmss>");
			return;
		}
		...
		File log4jConfigFile = new File(confDir, MODULE_KAFKA_APPFEEDBACK
		...
		File applicationContextFile = new File(confDir, MODULE_KAFKA_APPFEEDBACK
