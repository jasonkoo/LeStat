...
public class AppData2KafkaInDevEnv {

	private static Logger logger = Logger.getLogger(App.class);

	public final static String MODULE_NAME = "test02";

	public static void main(String[] args) {
		if (args.length != 1) {
			System.out
					.println("Usage : java com.lenovo.push.marketing.lestat.kafka.writer.test.Data2KafkaInDevEnv -Dlestat.home=<lestat.home> -Dlogfile.name=<logfile.name> test02");
			return;
		}
		...
		AppKafkaWriter writer = new AppKafkaWriter();
		writer.start();
