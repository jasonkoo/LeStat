package com.lenovo.push.marketing.lestat.kafka;
...
public class App {
	...
	public final static String MODULE_KAFKA = "kafka";

	public static void main(String[] args) {
		if (args.length != 4) {
			System.out
					.println("Usage : java com.lenovo.push.marketing.lestat.kafka.App -Dlestat.home=<lestat.home> -Dlogfile.name=<logfile.name> kafka <readerIndex> <readerCount> <yyyyMMddHHmmss>");
			return;
		}
		...
		File log4jConfigFile = new File(confDir, MODULE_KAFKA
		...
		File applicationContextFile = new File(confDir, MODULE_KAFKA
