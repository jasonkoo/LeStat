...
import com.lenovo.push.marketing.lestat.db.hive.dao.BaseDao;
import com.lenovo.push.marketing.lestat.db.hive.mapper.BaseMapper;
...
public class BaseDaoImpl<T, E> extends SqlSessionDaoSupport implements BaseDao<T, E>
{
	...
	@Autowired
	public void setSqlSessionTemplate(@Qualifier("hiveSqlSessionTemplate") SqlSessionTemplate sqlSessionTemplate) {
