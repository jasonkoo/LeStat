package com.lenovo.push.marketing.lestat.db.mysqlx.dao.impl;
...
import com.lenovo.push.marketing.lestat.db.mysql1.dao.BaseDao;
import com.lenovo.push.marketing.lestat.db.mysql1.mapper.BaseMapper;
import com.lenovo.push.marketing.lestat.db.util.Page;
...
public class BaseDaoImpl<T, E> extends SqlSessionDaoSupport implements BaseDao<T, E>
{
	...
	@Autowired
	public void setSqlSessionTemplate(@Qualifier("mysql1SqlSessionTemplate") SqlSessionTemplate sqlSessionTemplate) {
