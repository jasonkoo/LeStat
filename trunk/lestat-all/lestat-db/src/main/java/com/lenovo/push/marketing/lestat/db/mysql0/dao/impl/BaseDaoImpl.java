...
import com.lenovo.push.marketing.lestat.db.mysql0.dao.BaseDao;
import com.lenovo.push.marketing.lestat.db.mysql0.mapper.BaseMapper;
...
public class BaseDaoImpl<T, E> extends SqlSessionDaoSupport implements BaseDao<T, E>
{
	...
	@Autowired
	public void setSqlSessionTemplate(@Qualifier("mysql0SqlSessionTemplate") SqlSessionTemplate sqlSessionTemplate) {
