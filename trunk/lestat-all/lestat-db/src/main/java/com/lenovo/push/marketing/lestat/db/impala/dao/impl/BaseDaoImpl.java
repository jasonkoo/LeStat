...
import com.lenovo.push.marketing.lestat.db.impala.dao.BaseDao;
import com.lenovo.push.marketing.lestat.db.impala.mapper.BaseMapper;
...
public class BaseDaoImpl<T, E> extends SqlSessionDaoSupport implements BaseDao<T, E>
{
	...
	@Autowired
	public void setSqlSessionTemplate(@Qualifier("impalaSqlSessionTemplate") SqlSessionTemplate sqlSessionTemplate) {
