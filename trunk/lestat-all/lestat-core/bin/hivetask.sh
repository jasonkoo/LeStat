...
MAIN=com.lenovo.push.marketing.hive.task.HiveTaskMain
...
#$JAVA_HOME/bin/java -Dlestat.home=$APP_HOME -Dlogfile.name=lestat-hivetask.log $MAIN hivetask -d 20140904,20140902 -s 21,33 -a p,q,3
$JAVA_HOME/bin/java -Dlestat.home=$APP_HOME -Dlogfile.name=lestat-hivetask.log $MAIN hivetask
